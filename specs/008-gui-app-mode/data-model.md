...
@dataclass
class UserConfig:
    """用户偏好设置，持久化到 ~/.task-mind/gui_config.json"""
...
class CommandType(Enum):
    AGENT = "agent"       # task-mind agent 调用
    RECIPE = "recipe"     # 配方执行
...
@dataclass
class RecipeItem:
    """配方列表项（从 task-mind recipe list 获取）"""
    name: str
...
def refresh_recipes() -> List[RecipeItem]:
    """从 task-mind recipe list 刷新配方列表"""
    pass
