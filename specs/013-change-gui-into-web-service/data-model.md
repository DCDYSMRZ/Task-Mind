...
This document defines the data models for the web service API. Most entities already exist in the codebase (`src/task-mind/gui/models.py`) and will be reused. This document focuses on the new entities needed for the HTTP/WebSocket transport layer.
...
| agent_type | string | Agent type (claude/task-mind) |
...
| Field | Type | Description |
|-------|------|-------------|
| version | string | Task-Mind version |
