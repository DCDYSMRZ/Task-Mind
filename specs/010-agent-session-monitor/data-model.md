...
表示一个被 Task-Mind 监控的 Agent 执行会话。
...
```json
{
  ...
  "agent_type": "claude",
  "project_path": "/home/yammi/repos/Task-Mind",
  "source_file": "~/.claude/projects/-home-yammi-repos-Task-Mind/48c10a46-9f16-4d56-8c65-26de8a5af65c.jsonl",
