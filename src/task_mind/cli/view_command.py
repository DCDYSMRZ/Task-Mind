...
def view(
    ...
    Opens content in a new Chrome tab. Automatically starts task-mind server and
    ...
    \b
    Examples:
      task-mind view README.md           # View Markdown
      task-mind view report.pdf          # View PDF
      task-mind view config.json         # View formatted JSON
      task-mind view slides.html         # View reveal.js slides
      task-mind view video.mp4           # Play video
      task-mind view model.glb           # View 3D model
      cat script.py | task-mind view --stdin  # Read from stdin
    """
    ...
    try:
        from task_mind.viewer.chrome import ChromeViewer
