    ...
    def _to_clipboard(data: dict[str, Any]) -> None:
        ...
        try:
            ...
            raise RuntimeError(
                ...
                "Installation:\n"
                "  pip install task-mind-cli[clipboard]     # clipboard feature only\n"
                "  pip install task-mind-cli[all]           # all optional features\n"
                "  uv tool install 'task-mind-cli[clipboard]'  # for uv users"
            )
