...
class EnvService:
    ...
    def get_env_vars() -> Dict[str, Any]:
        """Get user-level environment variables from ~/.task-mind/.env.

        Returns:
            Dictionary with 'vars' (env dict) and 'file_exists' (bool).
        """
        from task_mind.recipes.env_loader import EnvLoader
    ...
    def update_env_vars(updates: Dict[str, Optional[str]]) -> Dict[str, Any]:
        ...
        """
        from task_mind.recipes.env_loader import EnvLoader, update_env_file
