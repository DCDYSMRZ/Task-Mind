...
Provides functionality for syncing Task-Mind resources across multiple devices
...
from task_mind.server.services.base import run_subprocess
...
class MultiDeviceSyncService:
    ...
    def _do_sync(cls) -> None:
        ...
        try:
            from task_mind.tools.sync_repo import sync
