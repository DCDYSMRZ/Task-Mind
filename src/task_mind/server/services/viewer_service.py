...
Content is stored in ~/.task-mind/viewer/ with automatic cleanup of old content.
"""
...
VIEWER_DIR = Path.home() / ".task-mind" / "viewer"
...
class ViewerService:
    ...
    def _render_present_html(
        ...
        from task_mind.viewer.modes.present import render_presentation
    ...
    def _render_doc_html(
        ...
        from task_mind.viewer.modes.document import render_document
    ...
    def _render_media_html(
        ...
        """
        from task_mind.viewer.modes.media import (
            render_video,
            render_image,
            render_audio,
            render_3d,
