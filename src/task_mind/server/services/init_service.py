"""Initialization service for web-based task-mind init functionality.
...
from task_mind.init.config_manager import load_config, save_config, update_config
from task_mind.init.installer import (
    get_platform_node_install_guide,
    install_claude_code,
    install_node,
)
from task_mind.init.models import DependencyCheckResult
from task_mind.init.resources import get_resources_status, install_all_resources
...
class InitService:
    ...
    def get_init_status() -> Dict[str, Any]:
        ...
        return {
            ...
            "current_task_mind_version": current_version,
    ...
    def install_dependency(name: str) -> Dict[str, Any]:
        ...
        """
        from task_mind.init.exceptions import CommandError
    ...
    def install_resources(force_update: bool = False) -> Dict[str, Any]:
        ...
        try:
            ...
            return {
                ...
                "errors": all_errors,
                "task_mind_version": result.task_mind_version,
            }
        except Exception as e:
