...
export default function GitHubWizard({ onComplete, onCancel }: GitHubWizardProps) {
  ...
  const [repoName, setRepoName] = useState('task-mind-sync');
      ...
      {repoMode === 'create' ? (
        ...
        <div>
          ...
          <input
            ...
            placeholder="e.g., task-mind-sync"
          ...
          <p className="mt-2 text-sm text-[var(--text-muted)]">
            A private repository will be created under your GitHub account to sync task-mind resources
          </p>
        </div>
      ) : (
        ...
        <div>
          ...
          <p className="mt-2 text-sm text-[var(--text-muted)]">
            Select an existing repository to sync task-mind resources (private repository recommended)
          </p>
        </div>
      )}
  ...
  const renderStep4 = () => (
    <div className="space-y-4">
      ...
      <p className="text-sm text-[var(--text-secondary)]">
        Now performing the first sync to upload local task-mind resources to the GitHub repository.
      </p>
      ...
      <div className="card bg-green-50 dark:bg-green-900/20 border-green-200 dark:border-green-800">
        <div className="space-y-2">
          ...
          <p className="text-sm text-green-700 dark:text-green-300">
            Your task-mind resources (commands, skills, recipes) can now be synced across multiple devices.
          </p>
        </div>
      </div>
