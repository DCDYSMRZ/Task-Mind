 ...
 * Keep in sync with the Python backend TaskMindGuiApi class.
 */
...
export interface PyWebviewApi {
  ...
  /**
   * Get main config (~/.task-mind/config.json)
   */
  ...
  /**
   * Get user-level environment variables (~/.task-mind/.env)
   */
  ...
  /**
   * Execute task-mind sync (background thread)
   */
