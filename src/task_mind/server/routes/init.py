"""Init API routes for web-based task-mind initialization.
...
from task_mind.server.services.init_service import InitService
...
async def get_init_status():
    ...
    try:
        ...
        return InitStatusResponse(
            ...
            current_task_mind_version=result["current_task_mind_version"],
...
async def install_resources(request: ResourceInstallRequest = None):
    ...
    - Example recipes (~/.task-mind/recipes/)
    """
    try:
        ...
        return ResourceInstallResponse(
            ...
            task_mind_version=result.get("task_mind_version"),
