---
name: task-mind-view-content-generate-tips-code
description: Code file content generation guide. Use this skill when you need to create code files that can be previewed via `task-mind view`. Covers supported languages, theme selection, and best practices.
---

# Code File Content Generation Guide

Preview code files via `task-mind view` with automatic syntax highlighting.

## Preview Commands

```bash
task-mind view script.py                      # Default theme
task-mind view script.py --theme monokai      # Specify theme
```
...
task-mind view main.py --theme monokai
task-mind view config.yaml --theme atom-one-dark
```
