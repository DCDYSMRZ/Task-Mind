---
name: task-mind-view-content-generate-tips-markdown
description: Markdown document content generation guide. Use this skill when you need to create Markdown documents that can be previewed via `task-mind view`. Covers element support, Mermaid charts, and best practices.
---

# Markdown Document Content Generation Guide

Create high-quality Markdown documents that can be previewed via `task-mind view`.

## Preview Commands

```bash
task-mind view document.md                    # Default theme
task-mind view document.md --theme monokai    # Specify code theme
```
