...
uv run task-mind scroll-to "AI will change the way we work"
```
...
uv run task-mind scroll-to "core keywords"
```
...
- task-mind scroll-to command: `uv run task-mind scroll-to --help`
