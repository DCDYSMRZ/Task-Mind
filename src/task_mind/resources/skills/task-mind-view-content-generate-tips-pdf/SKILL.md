---
name: task-mind-view-content-generate-tips-pdf
description: PDF file content generation guide. Use this skill when you need to understand how `task-mind view` previews PDF files. Covers rendering features and limitations.
---

# PDF File Content Generation Guide

Preview PDF files via `task-mind view`, based on PDF.js client-side rendering.

## Preview Commands

```bash
task-mind view document.pdf
```
