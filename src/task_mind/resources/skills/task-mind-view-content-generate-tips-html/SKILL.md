---
name: task-mind-view-content-generate-tips-html
description: HTML/reveal.js content generation guide. Use this skill when you need to create HTML presentations that can be previewed via `task-mind view`. Covers reveal.js advanced design, CSS techniques, and multi-page collaboration workflow.
---

# HTML/reveal.js Content Generation Guide

Create professionally designed HTML presentations and preview them via `task-mind view`.
...
**Note**: `task-mind view` automatically injects reveal.js library, no manual inclusion needed.
...
```bash
task-mind view slides.html              # Default theme
task-mind view slides.html --theme dracula  # Specify theme
task-mind view slides.html --fullscreen     # Fullscreen mode
```
...
3. User previews: `task-mind view slides.html`
