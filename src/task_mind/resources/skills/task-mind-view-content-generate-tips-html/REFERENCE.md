...
| **Script Injection** | Limited | task-mind view auto-injects required libraries |
...
|-------------|------------|
| Debug CSS/HTML | Debug in Chrome first, then confirm with `task-mind view` |
...
5. **Static Content**: task-mind view is suitable for static display, not interactive applications
