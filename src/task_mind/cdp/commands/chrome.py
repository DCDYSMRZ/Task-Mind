...
class ChromeLauncher:
    ...
    def __init__(
        ...
        if profile_dir:
            ...
            self.profile_dir = Path.home() / ".task-mind" / f"chrome_profile_{port}"
        else:
            # Default use ~/.task-mind/chrome_profile
            self.profile_dir = Path.home() / ".task-mind" / "chrome_profile"
