...
class AutostartManager(ABC):
    ...
    def enable(self) -> tuple[bool, str]:
        """Enable autostart for task-mind server.
    ...
    def disable(self) -> tuple[bool, str]:
        """Disable autostart for task-mind server.
    ...
    def _collect_environment_path(self) -> str:
        ...
        for cmd in ["node", "claude", "task-mind"]:
        ...
        if system == "Darwin":
            ...
            # Windows: common locations handled by _get_task_mind_path
            pass
