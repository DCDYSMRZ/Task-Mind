...
Titles are stored in ~/.task-mind/sessions.json, separate from session metadata.
"""
...
SESSIONS_JSON_PATH = Path.home() / ".task-mind" / "sessions.json"
...
class TitleManager:
    ...
    def _get_session_content(
        ...
        try:
            from task_mind.session.storage import read_steps
