...
Contains all Pydantic models used by task-mind init command:
...
class Config(BaseModel):
    """Task-Mind configuration entity (persisted to ~/.task-mind/config.json)"""
    ...
    community_repo: str = "DCDYSMRZ/Task-Mind"  # GitHub repo for community recipes
...
class TemporaryState(BaseModel):
    """Temporary state (for Ctrl+C recovery, saved to ~/.task-mind/.init_state.json)"""
