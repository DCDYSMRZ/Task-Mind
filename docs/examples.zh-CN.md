...
```bash
uv run task-mind recipe run test_inspect_tab
```
...
# 导航到GitHub
task-mind chrome navigate https://github.com
sleep 3
...
# 执行页面操作
sleep 2
task-mind chrome scroll down 500
sleep 3
...
# 导航到Notion产品页
task-mind chrome navigate https://www.notion.so/product
sleep 3
...
# 聚光灯效果
task-mind chrome spotlight ".hero-section" 3
sleep 3

# 高亮特性卡片
task-mind chrome highlight ".feature-card:nth-child(1)" --color "#FF6B6B" --duration 2
sleep 2

# 滚动页面
task-mind chrome scroll down 800 --smooth
sleep 2

# 添加标注
task-mind chrome annotate ".pricing-section" "灵活的定价方案" --position top
sleep 2
