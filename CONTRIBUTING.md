# Contributing to task-mind Thank you for your interest in the task-mind project! We welcome contributions of all kinds.
...
cd task-mind # Install with uv in development mode
uv pip install -e .
