...
| `/tmp/task-mind-*` | Read/Write (temporary) |
| `~/.task-mind/` | **Prohibited** (task-mind internal only) |
...
- Session data from `~/.task-mind/sessions/`
- Configuration files from `~/.task-mind/config.json`
