...
Thank you for contributing to the task-mind community recipes!
...
```bash
task-mind recipe run my-recipe --params '{"url": "https://example.com"}'
```
```
...
3. **Test** locally:
   ```bash
   task-mind recipe validate /path/to/your/recipe
   task-mind recipe run your-recipe --params '{...}'
   ```
...
- Accessing `~/.task-mind/`, `~/.claude/`, `~/.ssh/`

## Questions?

Open an issue in the main task-mind repository if you have questions about contributing.
